...
- 관련 계약 문서 경로
  ...
  - `registry/platform-4.0.0-adoption.md`
...
5. 각 서비스 레포 구현을 계약과 동일하게 맞춘다.
   - platform dependency를 바꾸는 작업이면 `registry/platform-4.0.0-adoption.md`의 dependency placement / verification order를 그대로 따른다.
...
- Editor(main): 문서/블록 도메인 API 계약 수용
